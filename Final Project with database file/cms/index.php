    ...
    <div class="jumbotron">
        <div class="container">
            <div id="details" class="animated fadeInLeft">
                <h1>Anik786<span>Blog</span></h1>
                <p>This is an online Blogging site . So shine With us now</p>
            </div>
            ...
            if(mysqli_num_rows($run) > 0){
              ...
              ?>
                ...
                <div class="post">
                    ...
                    <a href="post.php?post_id=<?php echo $id; ?>" class="btn bpost.php?post_id=<?php echo $id; ?>tn-primary">Read More</a>
                    <div class="bottom">
